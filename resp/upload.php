...
if($est_sesion==0)
{
	...
	if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') 
	{
	    ...
	    if ($file && move_uploaded_file($_FILES['i_file']['tmp_name'],"files/".$_REQUEST['names'].".".$name_file[1]))
	    {
	    	sleep(2);
	    	// El archivo
	    ...
	    if ($file2 && move_uploaded_file($_FILES['i_file2']['tmp_name'],"files/".$_REQUEST['names']."_2.".$name_file[1]))
	    {
	      sleep(2);
	    	// El archivo
