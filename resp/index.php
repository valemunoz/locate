  ...
  <div data-role="page" id="m_checkout5" data-theme="a">
     ...
     <tbody>
       ...
       <tr>         
       	...
       	{
       	?>
         <td><a href="mod_image.php?img=<?=$produc[7]?>" data-rel="dialog" data-transition="pop" data-inline="true"><h4><?=substr(ucwords($produc[2]), 0, 30);?></h4></a><input type="hidden" id="pro_<?=$i?>" name="tot_pro" value="<?=$produc[0]?>"></td>
        <?php
       	}else
       	{
       		?>
