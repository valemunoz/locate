    ...
    <div data-role="page" id="mappage" data-theme="a">
			 <div data-role="panel" id="mypanel" data-theme="a" style="z-index:99999;" data-position="left" data-display="overlay">
    	  	<a href="#mypanel" data-iconpos="top" data-rel="close" data-icon="delete" data-role="button" data-iconpos="notext"></a>
			  	  ...
			  	  <?php
			  	  if($_SESSION['app']==4 or $_SESSION['app']==5 or $_SESSION['app']==6)
			  	  {
  ...
  <div data-role="page" id="m_checkout5" data-theme="a">
     ...
     <tbody>
       ...
       <tr>         
       	...
       	{
       	?>
         <td><a href="mod_image.php?img=<?=$produc[7]?>&valor=<?=$produc[5]?>" data-rel="dialog" data-transition="pop" data-inline="true"><h4><?=substr(ucwords($produc[2]), 0, 30);?></h4></a><input type="hidden" id="pro_<?=$i?>" name="tot_pro" value="<?=$produc[0]?>"></td>
        <?php
       	}else
       	{
       		?>
         		<td><h4><?=substr(ucwords($produc[2]), 0, 30);?></h4><input type="hidden" id="pro_<?=$i?>" name="tot_pro" value="<?=$produc[0]?>"></td>
        	<?php
       	}
         ?>
         <td><input type="number" id="pr_<?=$i?>" name="pr_<?=$i?>" value="0"></td>
         <td><input type="number" id="prf_<?=$i?>" name="prf_<?=$i?>" value="0"></td>
         <td><input type="number" id="prv_<?=$i?>" name="prv_<?=$i?>" value="0"></td>
       </tr>
       <?php
       $i++;
     		}
  ...
  <div data-role="page" id="m_checkout5" data-theme="a">
     ...
     <tbody>
       ...
       <tr>         
       	...
       	{
       	?>
         <td><a href="mod_image.php?img=<?=$produc[7]?>&valor=<?=$produc[5]?>" data-rel="dialog" data-transition="pop" data-inline="true"><h4><?=substr(ucwords($produc[2]), 0, 30);?></h4></a><input type="hidden" id="pro_<?=$i?>" name="pro_<?=$i?>" value="<?=$produc[0]?>"></td>
        <?php
       	}else
       	{
       		?>
         		<td><h4><?=substr(ucwords($produc[2]), 0, 30);?></h4><input type="hidden" id="pro_<?=$i?>" name="pro_<?=$i?>" value="<?=$produc[0]?>"></td>
        	<?php
       	}
         ?>
         <td><h4><?=$produc[5]?></h4></td>
         <td><input type="number" id="cant_<?=$i?>" name="cant_<?=$i?>" value="0"></td>
   ...
   <input type="hidden" id="tot_pro" name="tot_pro" value="<?=$i?>">
					<input type="button" onclick="checkOutPedido()" value="CheckOut">
			...
			<div data-role="header" >   			 
      		<h1>Detalle <span id="t_agenda"></span></h1>  
				...
				<div data-role="content" data-theme="b" id="cont_agenda">
					...
					<label for="textarea" class="txt_pop"><h4>Hora : <span id="ag_hora"></span></h4> </label>
