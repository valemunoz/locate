...
<table id=table_filtro style="text-align:center;">
             ...
             <tr>
             	<td >
                    <a href="javascript:window.location='lugares.php'"><img src="img/lugar.png" height=30px width=30px title="Lugares"></a>
                </td>
                <td >
                ...
                if($_SESSION['app_web']==4 or $_SESSION['app_web']==5 or $_SESSION['app_web']==6)
                {
                ?>
                <td >
                ...
                <?php
              	...
              	if($_SESSION['app_web']==5 or $_SESSION['app_web']==6)
                {
                ?>
                <td >
