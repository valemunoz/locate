...
<script src="funciones.js"></script>
	...
	<script src="http://www.colombiamap.co/OpenLayers/OpenLayers.js"></script>
	 	<script src="http://www.colombiamap.co/js/funciones_api.js"></script>
		<script>
			 $(function() {
    $( "#grilla" ).dialog({
      autoOpen: false,
...
<div id="spacer" style="height:50px"></div>
	...
	<div id="grilla" title="Datos">

	</div>
	<div id="grilla_mapa" title="Mapa">
  <div id="mapa">
  </div>
